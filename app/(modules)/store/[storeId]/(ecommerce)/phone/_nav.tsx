...
import { Package, ScanLine, Users, Shield, BarChart2, Settings } from "lucide-react";
import type { NavProps } from "@/components/store/store-shell";

export default function PhoneNav({ storeId, pathname, onNavigate }: NavProps) {
  const base = `/store/${storeId}/phone`;
  const items = [
    ...
    { href: `${base}/warranty`,  label: "Bảo hành",   icon: Shield },
