...
import { LayoutGrid, ClipboardList, BookOpen, ChefHat, BarChart2, Settings } from "lucide-react";
import type { NavProps } from "@/components/store/store-shell";

export default function RestaurantNav({ storeId, pathname, onNavigate }: NavProps) {
  const base = `/store/${storeId}/restaurant`;
  const items = [
    ...
    { href: `${base}/kitchen`, label: "Bếp",       icon: ChefHat },
