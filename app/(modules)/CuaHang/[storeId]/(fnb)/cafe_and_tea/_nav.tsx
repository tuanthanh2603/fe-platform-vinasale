...
export default function CafeAndTeaNav({ storeId, pathname, onNavigate }: NavProps) {
  const base = `/store/${storeId}/cafe_and_tea`;
  const items = [
    { href: `${base}/tables`,  label: "Bàn",      icon: LayoutGrid },
    { href: `${base}/orders`,  label: "Đơn hàng", icon: ClipboardList },
    { href: `${base}/menu`,    label: "Menu",      icon: BookOpen },
