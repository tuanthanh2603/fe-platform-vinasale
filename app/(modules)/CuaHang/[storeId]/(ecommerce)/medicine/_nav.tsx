...
import { Package, ScanLine, Users, FileText, BarChart2, Settings } from "lucide-react";
import type { NavProps } from "@/components/store/store-shell";

export default function MedicineNav({ storeId, pathname, onNavigate }: NavProps) {
  const base = `/store/${storeId}/medicine`;
  const items = [
    ...
    { href: `${base}/prescriptions`, label: "Đơn thuốc",  icon: FileText },
