...
import { Package, ScanLine, Users, Warehouse, BarChart2, Settings } from "lucide-react";
import type { NavProps } from "@/components/store/store-shell";

export default function GroceryNav({ storeId, pathname, onNavigate }: NavProps) {
  const base = `/store/${storeId}/grocery`;
  const items = [
    ...
    { href: `${base}/inventory`, label: "Kho hàng",   icon: Warehouse },
