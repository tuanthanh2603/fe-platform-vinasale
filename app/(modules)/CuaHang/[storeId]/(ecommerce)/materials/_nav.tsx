...
import { Package, ScanLine, Users, Truck, BarChart2, Settings } from "lucide-react";
import type { NavProps } from "@/components/store/store-shell";

export default function MaterialsNav({ storeId, pathname, onNavigate }: NavProps) {
  const base = `/store/${storeId}/materials`;
  const items = [
    ...
    { href: `${base}/purchase-orders`, label: "Nhập hàng",     icon: Truck },
