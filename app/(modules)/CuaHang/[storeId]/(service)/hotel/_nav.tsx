...
import { BedDouble, CalendarRange, Users, Brush, BarChart2, Settings } from "lucide-react";
import type { NavProps } from "@/components/store/store-shell";

export default function HotelNav({ storeId, pathname, onNavigate }: NavProps) {
  const base = `/store/${storeId}/hotel`;
  const items = [
    ...
    { href: `${base}/housekeeping`, label: "Buồng phòng", icon: Brush },
