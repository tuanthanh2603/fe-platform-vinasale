...
import { CalendarCheck, Sparkles, Users, Clock, BarChart2, Settings } from "lucide-react";
import type { NavProps } from "@/components/store/store-shell";

export default function SpaNav({ storeId, pathname, onNavigate }: NavProps) {
  const base = `/store/${storeId}/spa`;
  const items = [
    { href: `${base}/appointments`, label: "Lịch hẹn",    icon: CalendarCheck },
    { href: `${base}/services`,     label: "Dịch vụ",     icon: Sparkles },
